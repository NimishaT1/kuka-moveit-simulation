...
: ${AMENT_CURRENT_PREFIX:="/wipro_ws/install/kuka_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/kuka_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/kuka_pkg/environment/path.sh"
